...
/*!	
  ...
  \note    IntDivisionNode Class publicly inherits from OperatorNode class 
		   and adds its own print and evaluate functions
*/
class IntDivisionNode : public OperatorNode 
{
  public:
/*!		
	\brief Constructor of IntDivisionNode uses OperatorNode's constructor as members initializer
	\param L: pointer to ExpNode
	\param R: pointer to ExpNode
	\post  A new IntDivisionNode is created with the parameter
*/
  IntDivisionNode(ExpNode *L, ExpNode *R): OperatorNode(L,R) 
  {
		// Empty
  }
/*!
